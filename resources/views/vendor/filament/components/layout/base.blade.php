...
>
    <head>
        ...
        <style>
            ...
            .filament-page-heading,
            .fi-page-heading,
            .filament-page-heading .filament-page-heading-content,
            .fi-page-heading .fi-page-heading-content {
            ...
            .filament-page-heading-heading,
            .fi-heading-title,
            .filament-page-heading .fi-heading-title {
                color: #f8fafc !important;
            }

            .filament-page-heading-description,
            .fi-heading-description {
                color: #a5b4fc !important;
            }

            .filament-page-heading .filament-breadcrumbs,
            .fi-page-heading .fi-breadcrumbs,
            .filament-breadcrumbs,
            .fi-breadcrumbs {
            ...
            .fi-page-actions,
            .fi-page-heading-actions,
            .filament-page-heading-actions {
                gap: 0.75rem;
            }

            .filament-page-actions .filament-button,
            .fi-page-actions .fi-button,
            .filament-page-heading-actions .filament-button,
            .fi-page-heading-actions .fi-button {
                min-height: 3rem;
            }
